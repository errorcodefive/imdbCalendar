...
#look for : <h3 class="ipc-title__text">
#The Blackening has a type error, that's why it isnt being output Calendar
#Will need to debug to see what the type error is
